...
class Proxy
  ...
  # WRITE CODE HERE
  def on?
    @called_methods.append(:on?)
    true
  end

  def channel=(value)
    @called_methods.append(:channel=)
    @channel = value
  end

  def power
    true
    @called_methods.append(:power)
  end

  def messages
    unique_methods = []
    for method in @called_methods
      if unique_methods.bsearch{|element| element == method}
  ...
  def called?(method_name)
    true if @called_methods.bsearch{|element| element == method_name}
  end
  ...
  def upcase!
    @called_methods.append(:upcase!)
    @object = @object.upcase
  end

  def split
    @called_methods.append(:split)
    @object.split(" ")
  end
